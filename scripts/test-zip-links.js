...
const { TEST_ENCODED_COLLECTIONS, generateTestUrls, logTestUrls } = require('../src/utils/test-encodings.ts');
...
console.log('5. Check that the page title and description match the collection');

console.log('\n🔧 For Production Testing:');
console.log('Replace "http://localhost:5173" with "https://SergeiGolos.github.io"');